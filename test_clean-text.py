...
class TestCleanText(unittest.TestCase):
    ...
    def test_space_nop(self):
        result = render(
            pd.DataFrame({"A": [" x", " y"]}), P(colnames=["A"], type_space="nop")
        )
        assert_frame_equal(result, pd.DataFrame({"A": [" x", " y"]}))
    ...
    def test_space_remove_all(self):
        ...
        assert_frame_equal(result, pd.DataFrame({"A": ["ab", np.nan, "", "x"]}))
    ...
    def test_condense(self):
        ...
        assert_frame_equal(result, pd.DataFrame({"A": [" a b ", np.nan, " ", "x"]}))
    ...
    def test_punc(self):
        df = pd.DataFrame(
            {
                "A": [" 2, 0, 0. 1 ", "20.01", " 2 0 0 1\t", "2.001", ",,2..001 \t"],
            },
            dtype="category",
        )
        ...
        expected = pd.DataFrame(
            {"A": ["2001", "2001", "2001", "2001", "2001"]}, dtype="category"
        )
    ...
    def test_char_keep(self):
        ...
        assert_frame_equal(result, pd.DataFrame({"A": ["20", "café", "heyyo"]}))
    ...
    def test_char_delete(self):
        ...
        assert_frame_equal(result, pd.DataFrame({"A": ["20", "café", "hey yo"]}))
    ...
    def test_delete_nothing(self):
        ...
        assert_frame_equal(result, pd.DataFrame({"A": ["2.0", "café", "@hey, yo"]}))
    ...
    def test_merge_categories(self):
        ...
        assert_frame_equal(
            result, pd.DataFrame({"A": ["x", "x", "x", "y", np.nan]}, dtype="category")
        )
